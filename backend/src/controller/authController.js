...
// @access Public
//
// Body: { name, email, password, phone?, rollNumber? }
// ──────────────────────────────────────────────────────────────────────────────
exports.registerStudent = async (req, res, next) => {
    try {
        ...
        // ── Create student (password is hashed by pre-save hook) ──────
...
//         No signup — credentials are set in .env by the canteen manager.
//         ADMIN_USERNAME and ADMIN_PASSWORD in .env are the only valid credentials.
//
...
exports.loginAdmin = async (req, res, next) => {
    try {
        ...
        // ── Compare against predefined .env credentials ───────────────
